...
<ul>
    <li><a href='#string-replaceall-method'>Class field declarations</a></li>
    <li><a href='#private-methods'>Private Methods and fields</a></li>
    <li><a href='#private-accessors'>Static public methods and fields</a></li>
    <li><a href='#logical-operators-and-assignment-expressions'>Regexp Match Indices</a></li>
    <li><a href='#weakref-and-finalizers'>Top-level await</a></li>
    <li><a href='#promiseany-and-aggregateerror'>Ergonomic brand checks for Private Fields</a></li>
    <li><a href='#numeric-separators'>New .at() method on all the built-in indexables</a></li>
    <li><a href='#intllistformat'>Object Accessible Object.prototype.hasOwnProperty()</a></li>
    <li><a href='#datestyle-and-timestyle-options-for-intldatetimeformat'> ECMAScript class static initialization blocks </a></li>
</ul>
